...
const ChatPage = () => {
  ...
  const { users, activeUsersMap, updateUsers, updateActiveUsersMap } =
    useUsersStore();
  ...
  useEffect(() => {
    ...
    newSocket.on("chat msg", (msgRecieve) => {
      ...
      // console.log("Recieved time chat msgs " + chatMsgs);
  ...
  useEffect(() => {
    console.log("USEEFFECT UserS ACTIVE : ", usersActive);
    console.log("USEEFFECT activeUsers map: ", activeUsersMap);
    const data = {
      ...activeUsersMap,
      [usersActive.username]: usersActive.isActive,
    };
    console.log("Use effect data: " , data)
    updateActiveUsersMap(data);
  }, [usersActive]);
          ...
          <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
            <div className="flex flex-row items-center justify-center h-12 w-full">
              <div className="flex items-center justify-center rounded-2xl text-indigo-700 bg-indigo-100 h-10 w-10">
                <FaRocketchat className="w-10 h-6" />
              </div>
            ...
            <div className="flex flex-col mt-8">
              ...
              <Spin spinning={isLoading}>
                <div className="flex flex-col space-y-1 mt-4 -mx-2 h-52 overflow-y-auto">
                  <ChatUsers activeUsersMap={activeUsersMap} />
                </div>
              </Spin>
            </div>
          </div>
